...
$extractPath = "C:\Program Files\OpenSSH\OpenSSH-Win64"      # Extract path for unzipped files
...
powershell.exe -ExecutionPolicy Bypass -File "$extractPath\install-sshd.ps1"
